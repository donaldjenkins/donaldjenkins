...
Social networking, which was in its infancy when I started using it in 2006, has matured. Three years ago, a vast number of start-ups were competing in the field, and few people other than geeks actually bothered to use them. Today the sector is much more concentrated, meaning it makes sense not to use every social network in existence&hairsp;[^1].
