import { VideoProvider } from './chunk-4CA2OYTC.js';
import { createRAFLoop, LIST_SELECT, LIST_ADD } from './chunk-LYPKAAFP.js';
import { isHLSSupported, IS_CHROME } from './chunk-L5JIQHZZ.js';
import { preconnect, loadScript } from './chunk-HJOTOEX7.js';
import { TextTrack, TEXT_TRACK_READY_STATE, TEXT_TRACK_ON_MODE_CHANGE } from './chunk-BCHRLKDT.js';
...
function setupHLS(provider, { player, logger, delegate, $store, qualities, audioTracks, textTracks }, callbacks) {
  ...
  function onError(eventType, data) {
    ...
    if (data.fatal) {
      switch (data.type) {
        case "networkError":
          (_b = provider.instance) == null ? void 0 : _b.startLoad();
          break;
        case "mediaError":
          (_c = provider.instance) == null ? void 0 : _c.recoverMediaError();
          break;
        default:
