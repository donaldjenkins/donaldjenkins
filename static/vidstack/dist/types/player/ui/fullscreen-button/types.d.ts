...
import type { ToggleButtonEvents, ToggleButtonMembers, ToggleButtonProps } from '../toggle-button/types';
...
export interface FullscreenButtonMembers extends ToggleButtonMembers, Omit<FullscreenButtonProps, 'disabled'> {
}
/**
 ...
 * ```
 */
export interface MediaFullscreenButtonElement extends HTMLCustomElement<FullscreenButtonProps, FullscreenButtonEvents>, FullscreenButtonMembers {
}
