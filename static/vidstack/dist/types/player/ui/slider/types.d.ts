...
export type { SliderProps, SliderEvents, SliderCSSVars };
 ...
 * ```
 */
export interface MediaSliderElement extends HTMLCustomElement<SliderProps, SliderEvents, SliderCSSVars>, SliderMembers {
}
