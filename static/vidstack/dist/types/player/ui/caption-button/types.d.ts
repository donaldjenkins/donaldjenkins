...
export interface CaptionButtonMembers extends ToggleButtonMembers, Omit<CaptionButtonProps, 'disabled'> {
}
/**
 ...
 * ```
 */
export interface MediaCaptionButtonElement extends HTMLCustomElement<CaptionButtonProps, CaptionButtonEvents>, CaptionButtonMembers {
}
