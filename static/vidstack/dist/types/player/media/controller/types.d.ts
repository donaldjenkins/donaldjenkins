...
export interface MediaControllerProps extends Pick<MediaStore, 'autoplay' | 'controls' | 'crossorigin' | 'currentTime' | 'loop' | 'muted' | 'paused' | 'playsinline' | 'poster' | 'preload' | 'playbackRate' | 'viewType' | 'volume' | 'streamType' | 'liveEdgeTolerance' | 'minLiveDVRWindow'> {
    /**
