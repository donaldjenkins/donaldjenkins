import { setAttribute, useDisposalBin, listenEvent, dispatchEvent } from './chunk-FFBW6SEG.js';
import { isUndefined, isFunction2, isString, isNumber, onDispose, isNil } from './chunk-GKRV3IQ4.js';
...
function setupHTMLMediaElementEvents(provider, { player, $store: $media, delegate, logger, audioTracks }) {
  ...
  function attachInitialEventListeners() {
    ...
    attachMediaEventListener("error", onError2);
    {
...
export { AUDIO_EXTENSIONS, AUDIO_TYPES, HLS_VIDEO_EXTENSIONS, HLS_VIDEO_TYPES, HTMLMediaProvider, IS_CHROME, IS_SAFARI, LIST_ADD, LIST_ON_REMOVE, LIST_ON_RESET, LIST_ON_USER_SELECT, LIST_READONLY, LIST_REMOVE, LIST_RESET, LIST_SELECT, LIST_SET_READONLY, VIDEO_EXTENSIONS, VIDEO_TYPES, canOrientScreen, canPlayHLSNatively, canUsePictureInPicture, canUseVideoPresentation, clampNumber, createRAFLoop, getNumberOfDecimalPlaces, isHLSSrc, isHLSSupported, round };
